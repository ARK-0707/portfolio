      ...
      <Card className='group overflow-hidden relative'>
          <CardHeader className='p-0'>
              ...
              <div className='relative w-full h-[300px] flex items-center justify-center bg-tertiary dark:bg-secondary/40 xl:bg-work_project_bg_light xl:dark:bg-work_project_bg_dark xl:bg-[110%] xl:bg-no-repeat overflow-hidden'>
                  {/* Adjusted Image container to use flex and removed absolute positioning */}
                  <div className='flex items-center justify-center w-full h-full'>
                      <Image src={project.image} width={300} height={300} alt="" priority className="object-cover" />
                  </div>
                  {/* btns links */}
                  <div className='flex gap-x-4 absolute items-center justify-center'>
